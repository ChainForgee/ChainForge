...
import { LivenessResponse, ReadinessResponse, DependenciesResponse } from './health.service';
...
@ApiServiceUnavailableResponse({ description: 'On-chain dependency is down.' })
async dependencies(
  @Res({ passthrough: true }) res: Response,
